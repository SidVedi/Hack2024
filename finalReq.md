...
| **Missing test fixtures** | Medium | Backend tests for A-1, A-2, A-3 require real tree node data from the database. Synthetic fixtures may not cover edge cases. | Self-serve: extract real fixtures from DB during A-1 investigation. Supplement with synthetic data for edge cases. |
...
| Real tree node fixtures | Extract during A-1 | Backend pytest tests | Cannot write meaningful backend tests | Extract from DB during A-1 investigation; supplement with synthetic data |
...
| Test data fixtures (tree nodes) | Self-serve during A-1 | Backend pytest tests | Cannot write meaningful backend tests | Extract real fixtures from DB during A-1 investigation; supplement with synthetic data |
