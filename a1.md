...
**Status:** INVESTIGATION COMPLETE — Bug is latent, not actively triggering for any tested scenario. V2 comparison confirms byte-for-byte identical range arrays.
...
Across 8 tests (7 on V1, 1 on V2) covering the full parameter space that the trainer endpoints serve:
