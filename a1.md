...
**Effort spent:** ~0.5 day investigation + ~1 hour defensive fix implementation
...
**Note:** Postflop trainer support is not planned. The following items are for reference only.
...
**Rationale:** Zero risk, ~1 hour effort, future-proofs against sparse compression
...
- No further action needed unless sparse compression is introduced
